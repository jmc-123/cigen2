...
function spcVocabExample(word, scene) {
  ...
  const examples = {
    airport: "e.g. We arrived at the ___ two hours early.",
    plane: "e.g. The ___ took off on time.",
    seat: "e.g. Please take your ___.",
    ticket: "e.g. I bought a one-way ___.",
    passport: "e.g. Don't forget your ___.",
    security: "e.g. We went through ___ quickly.",
    gate: "e.g. Boarding starts at ___ 12.",
    travel: "e.g. I love to ___ abroad.",
    food: "e.g. The ___ here is delicious.",
    drink: "e.g. Would you like something to ___?",
    coffee: "e.g. Let's grab a ___.",
    passenger: "e.g. Each ___ must show ID.",
    flight: "e.g. Our ___ is delayed.",
    time: "e.g. What ___ does it start?",
    service: "e.g. The room ___ is excellent.",
    visa: "e.g. I applied for a student ___.",
    officer: "e.g. The ___ asked me a few questions.",
    question: "e.g. May I ask you a ___?",
    form: "e.g. Please fill in this ___.",
    information: "e.g. I need some ___ about the schedule.",
    document: "e.g. Bring all required ___s.",
    country: "e.g. Which ___ are you from?",
    car: "e.g. We took a ___ to campus.",
    driver: "e.g. The ___ knew a shortcut.",
    road: "e.g. The ___ was very busy.",
    street: "e.g. The shop is on Main ___.",
    bridge: "e.g. We crossed the ___ over the river.",
    traffic: "e.g. The ___ is heavy today.",
    map: "e.g. Check the ___ for directions.",
    city: "e.g. This ___ has great food.",
    station: "e.g. The train ___ is nearby.",
    hotel: "e.g. We checked into the ___.",
    room: "e.g. The ___ has a nice view.",
    floor: "e.g. My office is on the third ___.",
    key: "e.g. Here is your ___ card.",
    window: "e.g. Open the ___ for fresh air.",
    door: "e.g. Please close the ___.",
    desk: "e.g. I left it on my ___.",
    bed: "e.g. The ___ is very comfortable.",
    shower: "e.g. I'll take a quick ___.",
    river: "e.g. We walked along the ___.",
    park: "e.g. Let's go to the ___ this weekend.",
    museum: "e.g. The ___ has a new exhibition.",
    shop: "e.g. There's a nice ___ near here.",
    market: "e.g. The ___ sells fresh fruit.",
    building: "e.g. That's a very old ___.",
    bus: "e.g. I take the ___ to work.",
    train: "e.g. The next ___ leaves at nine.",
    platform: "e.g. The ___ number is 3.",
    line: "e.g. Take ___ 2 to the university.",
    stop: "e.g. Get off at the next ___.",
    house: "e.g. They live in a small ___.",
    apartment: "e.g. The ___ has two bedrooms.",
    rent: "e.g. The monthly ___ is reasonable.",
    price: "e.g. What is the ___?",
    contract: "e.g. Read the ___ carefully.",
    owner: "e.g. The ___ is very friendly.",
    furniture: "e.g. The ___ is included.",
    university: "e.g. I study at this ___.",
    campus: "e.g. The ___ is beautiful in spring.",
    office: "e.g. My ___ is on the second floor.",
    lab: "e.g. We work in the ___ every day.",
    student: "e.g. She is a graduate ___.",
    staff: "e.g. The ___ here are very helpful.",
    professor: "e.g. The ___ gave an interesting lecture.",
    teacher: "e.g. My ___ is very patient.",
    researcher: "e.g. She is a top ___ in AI.",
    project: "e.g. Our ___ starts next month.",
    study: "e.g. I ___ English every morning.",
    research: "e.g. This ___ is very important.",
    topic: "e.g. The ___ of today's talk is AI.",
    team: "e.g. Our ___ has five members.",
    equipment: "e.g. The ___ is very advanced.",
    computer: "e.g. I need a new ___.",
    camera: "e.g. We use a high-speed ___.",
    device: "e.g. This ___ measures temperature.",
    system: "e.g. The ___ works automatically.",
    data: "e.g. We collected the ___ last week.",
    experiment: "e.g. The ___ took three hours.",
    plan: "e.g. What's the ___ for tomorrow?",
    idea: "e.g. That's a great ___!",
    problem: "e.g. We found a ___ with the design.",
    method: "e.g. This ___ is more efficient.",
    result: "e.g. The ___s were surprising.",
    test: "e.g. Let's run a quick ___.",
    answer: "e.g. I don't know the ___.",
    theory: "e.g. His ___ explains the pattern.",
    view: "e.g. In my ___, this approach works.",
    analysis: "e.g. The ___ shows a clear trend.",
    argument: "e.g. She made a strong ___.",
    evidence: "e.g. There is clear ___ for this.",
    model: "e.g. We built a new ___.",
    number: "e.g. The ___ of participants doubled.",
    figure: "e.g. See ___ 3 on page ten.",
    sample: "e.g. We tested 200 ___s.",
    report: "e.g. I finished the ___ yesterday.",
    paper: "e.g. She published a ___ last year.",
    article: "e.g. I read an interesting ___.",
    note: "e.g. I took ___s during the meeting.",
    conclusion: "e.g. The ___ is very clear.",
    meeting: "e.g. The ___ starts at 2 PM.",
    talk: "e.g. She gave a short ___.",
    presentation: "e.g. Your ___ was excellent.",
    slide: "e.g. Go to the next ___.",
    audience: "e.g. The ___ asked many questions.",
    conference: "e.g. I attended a ___ in Beijing.",
    discussion: "e.g. We had a long ___.",
    network: "e.g. Build your professional ___.",
    collaboration: "e.g. International ___ is valuable.",
    group: "e.g. Our ___ meets every Monday.",
    partner: "e.g. She is my research ___.",
    strategy: "e.g. We need a new ___.",
    policy: "e.g. The school ___ is strict.",
    program: "e.g. This ___ lasts two years.",
    menu: "e.g. Let me see the ___.",
    table: "e.g. A ___ for two, please.",
    tea: "e.g. Would you like some ___?",
    meat: "e.g. I don't eat much ___.",
    vegetable: "e.g. Eat more ___s.",
    bill: "e.g. Can I have the ___, please?",
    fruit: "e.g. Fresh ___ is healthy.",
    milk: "e.g. I drink ___ every morning.",
    bread: "e.g. We buy ___ from the bakery.",
    money: "e.g. How much ___ do I need?",
    bag: "e.g. Put it in the ___.",
    kitchen: "e.g. Let's cook in the ___.",
    dish: "e.g. This ___ tastes wonderful.",
    bowl: "e.g. Pour soup into the ___.",
    plate: "e.g. Put it on a ___.",
    knife: "e.g. Be careful with the ___.",
    spoon: "e.g. Stir with a ___.",
    cook: "e.g. I love to ___.",
    meal: "e.g. Dinner is the main ___.",
    sport: "e.g. What ___ do you play?",
    game: "e.g. We won the ___ yesterday.",
    football: "e.g. Let's play ___.",
    basketball: "e.g. He is good at ___.",
    run: "e.g. I ___ every morning.",
    exercise: "e.g. Regular ___ keeps you healthy.",
    competition: "e.g. She entered the ___.",
    hospital: "e.g. He was taken to the ___.",
    doctor: "e.g. See a ___ if you feel ill.",
    nurse: "e.g. The ___ gave me medicine.",
    medicine: "e.g. Take this ___ after meals.",
    drug: "e.g. The new ___ works well.",
    pill: "e.g. Take two ___s a day.",
    health: "e.g. Your ___ is most important.",
    disease: "e.g. This ___ is rare.",
    morning: "e.g. I wake up early every ___.",
    afternoon: "e.g. I have class this ___.",
    evening: "e.g. Let's meet in the ___.",
    night: "e.g. Good ___! Sleep well.",
    work: "e.g. I ___ from nine to five.",
    rest: "e.g. You need more ___.",
    sleep: "e.g. I didn't ___ well last night.",
    schedule: "e.g. What is your ___?",
    weather: "e.g. The ___ is nice today.",
    rain: "e.g. It will ___ tomorrow.",
    snow: "e.g. It rarely ___s here.",
    wind: "e.g. The ___ is very strong.",
    hot: "e.g. It's very ___ in summer.",
    cold: "e.g. It gets ___ in winter.",
    season: "e.g. Which ___ do you like best?",
    temperature: "e.g. The ___ dropped sharply.",
    internet: "e.g. The ___ is very fast here.",
    email: "e.g. I'll send you an ___.",
    message: "e.g. Did you get my ___?",
    phone: "e.g. My ___ battery is low.",
    update: "e.g. I have an ___ for you.",
    connection: "e.g. The wifi ___ is weak.",
    friend: "e.g. She is my best ___.",
    person: "e.g. He is a kind ___.",
    people: "e.g. Many ___ came to the event.",
    visitor: "e.g. We have a ___ today.",
    colleague: "e.g. My ___ helped me with the report.",
    name: "e.g. What is your ___?",
    job: "e.g. I enjoy my ___.",
    family: "e.g. My ___ lives nearby.",
    experience: "e.g. It was a great ___.",
    music: "e.g. I listen to ___ every day.",
    movie: "e.g. Let's watch a ___.",
    book: "e.g. I'm reading a good ___.",
    hobby: "e.g. Painting is my ___.",
    trip: "e.g. We went on a day ___.",
    picnic: "e.g. Let's have a ___ in the park.",
    party: "e.g. She organized a birthday ___.",
    barbecue: "e.g. We had a ___ last Sunday.",
    photo: "e.g. Let me take a ___.",
    history: "e.g. The ___ of this city is fascinating.",
    culture: "e.g. Chinese ___ is very rich.",
    art: "e.g. I appreciate modern ___.",
    tradition: "e.g. It's a local ___.",
    local: "e.g. Try the ___ food.",
    festival: "e.g. The spring ___ is exciting.",
    custom: "e.g. It is a traditional ___.",
    rule: "e.g. Follow the ___s.",
    polite: "e.g. It is ___ to say thank you.",
    behavior: "e.g. Good ___ is expected.",
    respect: "e.g. Show ___ to your elders.",
    communication: "e.g. Good ___ is important.",
    happy: "e.g. I feel very ___.",
    excited: "e.g. I'm ___ about the trip.",
    nervous: "e.g. I feel a bit ___.",
    worried: "e.g. Don't be ___.",
    proud: "e.g. I am ___ of your progress.",
    surprised: "e.g. I was ___ by the result.",
    curious: "e.g. I am ___ about your research.",
    mistake: "e.g. Everyone makes ___s.",
    misunderstanding: "e.g. It was just a ___.",
    explanation: "e.g. Thank you for the ___.",
    solution: "e.g. We found a good ___.",
    help: "e.g. Thank you for your ___.",
    suggestion: "e.g. I have a ___.",
    improvement: "e.g. There is room for ___.",
    fund: "e.g. We applied for research ___s.",
    grant: "e.g. She received a ___ for the project.",
    proposal: "e.g. Submit your ___ by Friday.",
    application: "e.g. The ___ deadline is next week.",
    budget: "e.g. We need to plan the ___.",
    course: "e.g. I'm taking a ___ in linguistics.",
    class: "e.g. Our ___ starts at 8 AM.",
    teaching: "e.g. She has a passion for ___.",
    lesson: "e.g. Today's ___ is about grammar.",
    education: "e.g. ___ is the key to success.",
    training: "e.g. The ___ program lasts three months.",
    career: "e.g. She has a successful ___.",
    position: "e.g. He applied for the ___.",
    skill: "e.g. Writing is an important ___.",
    opportunity: "e.g. It's a great ___.",
    memory: "e.g. I have good ___ies of that trip.",
    friendship: "e.g. Our ___ means a lot to me.",
    future: "e.g. Let's plan for the ___.",
    cooperation: "e.g. ___ benefits both sides.",
    mountain: "e.g. We climbed the ___ together.",
    air: "e.g. The ___ is so fresh here.",
    light: "e.g. The ___ is beautiful at sunset.",
    water: "e.g. Drink more ___.",
    field: "e.g. The ___s were full of flowers.",
    forest: "e.g. We walked through the ___.",
    sky: "e.g. The ___ is clear today.",
    stone: "e.g. She picked up a ___.",
    animal: "e.g. What ___ do you like?",
    bird: "e.g. I heard a ___ singing.",
    cat: "e.g. The ___ is sleeping.",
    dog: "e.g. I walk my ___ every day.",
    insect: "e.g. That ___ is harmless.",
    bee: "e.g. The ___ landed on a flower.",
    butterfly: "e.g. A ___ flew past us.",
    spider: "e.g. I saw a ___ on the wall.",
    plant: "e.g. This ___ needs more sunlight.",
    body: "e.g. Exercise is good for your ___.",
    head: "e.g. Wear a hat on your ___.",
    eye: "e.g. She has beautiful ___s.",
    ear: "e.g. I have a pain in my ___.",
    heart: "e.g. My ___ is beating fast.",
    lung: "e.g. Fresh air is good for your ___s.",
    muscle: "e.g. My ___s are sore after running.",
    bone: "e.g. He broke a ___ in his arm.",
    parent: "e.g. My ___s live in Shanghai.",
    daughter: "e.g. She is my oldest ___.",
    son: "e.g. Their ___ is a doctor.",
    father: "e.g. My ___ taught me to ride a bike.",
    mother: "e.g. My ___ is a great cook.",
    brother: "e.g. I have one ___.",
    sister: "e.g. My ___ studies abroad.",
    husband: "e.g. Her ___ works at the university.",
    wife: "e.g. His ___ is a researcher.",
    wall: "e.g. Hang the picture on the ___.",
    chair: "e.g. Please take a ___.",
    news: "e.g. I heard the ___ this morning.",
    event: "e.g. It was a big ___.",
    fact: "e.g. That is a well-known ___.",
    notice: "e.g. I saw the ___ on the board.",
    government: "e.g. The ___ made a new policy.",
    change: "e.g. We need to ___ our approach.",
    society: "e.g. We live in a modern ___.",
    reason: "e.g. What is the ___?",
    collection: "e.g. The ___ is impressive.",
    guide: "e.g. The ___ showed us around.",
    text: "e.g. Read the ___ carefully.",
  };
  return examples[w] || "";
}
