...
function spcVDetail() {
  ...
  <div class="${m.cls}">
    ...
    <div class="spc-card">
      ...
      <div class="spc-pills">
        ${s.vocab.map((w) => `<div class="spc-vocab-item"><span class="spc-chip spc-chip-fire">${w}</span><span class="spc-vocab-example">${spcVocabExample(w, s)}</span></div>`).join("")}
      </div>
    </div>
...
const SPC_SCENE_EXAMPLES = {
  1:{airport:"e.g. We need to arrive at the ___ by 6 AM for check-in.",plane:"e.g. The ___ to Beijing departs from Terminal 2.",seat:"e.g. My ___ is 14A, by the window.",ticket:"e.g. Show your boarding ___ at the gate.",passport:"e.g. Keep your ___ ready for inspection.",security:"e.g. Laptops must be removed at the ___ check.",gate:"e.g. Boarding starts at ___ 23 in ten minutes.",travel:"e.g. I ___ to China every summer for research."},
  2:{seat:"e.g. Excuse me, I think this is my ___.",food:"e.g. The in-flight ___ includes rice and chicken.",drink:"e.g. Would you like a hot or cold ___?",coffee:"e.g. Could I have a ___ with milk, please?",passenger:"e.g. The ___ next to me is from Germany.",flight:"e.g. Our ___ is about nine hours long.",time:"e.g. What ___ do we land?",service:"e.g. The cabin ___ on this airline is great."},
  3:{passport:"e.g. The officer checked my ___ and visa.",visa:"e.g. My student ___ is valid for one year.",officer:"e.g. The immigration ___ asked about my visit.",question:"e.g. They may ask ___s about your stay.",form:"e.g. Please fill out the arrival ___.",information:"e.g. Write your hotel ___ on the form.",document:"e.g. Prepare all ___s before you reach the desk.",country:"e.g. Which ___ are you visiting from?"},
  4:{car:"e.g. Let's take a ___ to the university.",driver:"e.g. The ___ knows the fastest route to campus.",road:"e.g. This ___ goes straight to the city centre.",street:"e.g. Our university is on Zhongshan ___.",bridge:"e.g. We'll cross the river ___ in about ten minutes.",traffic:"e.g. The ___ is usually heavy during rush hour.",map:"e.g. I'll show you the route on the ___.",city:"e.g. Welcome to our ___! It's very lively.",station:"e.g. The train ___ is just beside the highway."},
  5:{hotel:"e.g. The ___ is a ten-minute walk from campus.",room:"e.g. Your ___ is on the eighth floor.",floor:"e.g. The restaurant is on the ground ___.",key:"e.g. Here is your ___ card for the room.",window:"e.g. The ___ overlooks the garden.",door:"e.g. Please lock the ___ when you leave.",desk:"e.g. There is a work ___ next to the bed.",bed:"e.g. The ___ has been freshly made for you.",shower:"e.g. The ___ is in the bathroom on the left.",service:"e.g. You can call the front ___ anytime."},
  6:{city:"e.g. Our ___ has a long history of over 2,000 years.",river:"e.g. The ___ runs through the centre of town.",park:"e.g. People go to the ___ for morning exercise.",museum:"e.g. The history ___ is just across the street.",shop:"e.g. There are many small ___s near the campus.",market:"e.g. The night ___ sells local snacks.",street:"e.g. This old ___ is famous for its architecture.",bridge:"e.g. The stone ___ was built in the Ming Dynasty.",building:"e.g. That tall ___ is the city library."},
  7:{bus:"e.g. Take ___ number 15 to the campus gate.",train:"e.g. The metro ___ runs every five minutes.",station:"e.g. The nearest ___ is a short walk from here.",ticket:"e.g. You can buy a ___ from the machine.",platform:"e.g. Our train leaves from ___ 3.",map:"e.g. This transit ___ shows all the lines.",line:"e.g. Take ___ 2 and change at People's Square.",stop:"e.g. Get off at the third ___.",travel:"e.g. It's easy to ___ around the city by metro."},
  8:{house:"e.g. There's a ___ for rent near the campus.",apartment:"e.g. This ___ has two bedrooms and a balcony.",room:"e.g. The ___ is bright and quiet.",rent:"e.g. The monthly ___ is 3,000 yuan.",price:"e.g. The ___ includes water and electricity.",contract:"e.g. Sign the ___ before you move in.",owner:"e.g. The ___ lives downstairs.",furniture:"e.g. Basic ___ like a bed and desk is provided."},
  9:{university:"e.g. Welcome to our ___! Let me show you around.",campus:"e.g. The ___ has over 30 buildings.",office:"e.g. My ___ is in the science building.",building:"e.g. The new ___ houses three research labs.",lab:"e.g. Our ___ is on the fourth floor.",room:"e.g. The meeting ___ is down the hall.",student:"e.g. We have 50 graduate ___s this year.",staff:"e.g. The ___ are very supportive of visitors."},
  10:{professor:"e.g. The ___ leads our AI research group.",teacher:"e.g. My ___ supervised my doctoral thesis.",researcher:"e.g. She is an experienced ___ in applied linguistics.",project:"e.g. The ___ focuses on climate modelling.",study:"e.g. His ___ covers rural education policy.",research:"e.g. Her ___ has been published in top journals.",topic:"e.g. The main ___ of her work is machine learning.",team:"e.g. Our ___ includes scholars from three countries."},
  11:{lab:"e.g. This is where we run most of our experiments — our main ___.",equipment:"e.g. All the ___ was upgraded last year.",computer:"e.g. Each workstation has a high-performance ___.",camera:"e.g. The high-speed ___ captures 1,000 frames per second.",device:"e.g. This ___ records temperature and humidity.",system:"e.g. The data-collection ___ runs 24 hours a day.",data:"e.g. We store all ___ on a secure server.",experiment:"e.g. The ___ measures reaction time in milliseconds."},
  12:{project:"e.g. Our ___ aims to reduce water pollution.",plan:"e.g. The original ___ was to finish within two years.",idea:"e.g. The central ___ came from our fieldwork last summer.",problem:"e.g. The main ___ is the lack of reliable data.",method:"e.g. We use a mixed ___ combining surveys and interviews.",result:"e.g. The early ___s are very promising.",test:"e.g. We need to ___ the hypothesis under controlled conditions.",experiment:"e.g. Each ___ involves 50 participants."},
  13:{question:"e.g. I have a ___ about your methodology.",answer:"e.g. The ___ depends on how we define the variable.",theory:"e.g. This ___ explains why the pattern exists.",idea:"e.g. Your ___ about combining the two approaches is interesting.",view:"e.g. In my ___, the sample size is too small.",analysis:"e.g. Your ___ of the data is very thorough.",argument:"e.g. The ___ in your paper is well-structured.",evidence:"e.g. Is there enough ___ to support this claim?"},
  14:{data:"e.g. We collected ___ from 500 households.",model:"e.g. The prediction ___ has 95% accuracy.",result:"e.g. The ___s confirm our initial hypothesis.",number:"e.g. The ___ of valid responses was 312.",figure:"e.g. ___ 4 shows the distribution clearly.",sample:"e.g. Our ___ includes both urban and rural areas.",information:"e.g. This ___ helps explain the trend.",system:"e.g. The scoring ___ ranks each factor from 1 to 10."},
  15:{report:"e.g. I submitted the progress ___ this morning.",document:"e.g. Please review the ___ before our meeting.",text:"e.g. The main ___ is about 8,000 words.",paper:"e.g. We co-authored a ___ on renewable energy.",article:"e.g. The journal ___ was accepted last week.",note:"e.g. I added a ___ in the margin about this point.",idea:"e.g. The key ___ of the paper is on page three.",conclusion:"e.g. The ___ summarises our main findings."},
  16:{meeting:"e.g. The team ___ is scheduled for 3 PM.",talk:"e.g. Your ___ should be about 15 minutes long.",presentation:"e.g. Practise the ___ once before the meeting.",slide:"e.g. Keep each ___ focused on one main point.",topic:"e.g. The ___ today is project progress.",audience:"e.g. The ___ will include both faculty and students.",question:"e.g. Prepare for ___s about your methodology."},
  17:{conference:"e.g. The international ___ is held here every year.",discussion:"e.g. The panel ___ covered three topics.",research:"e.g. Scholars presented their latest ___ findings.",topic:"e.g. The main ___ this year is green technology.",network:"e.g. The ___ event after the talk is a great chance to connect.",project:"e.g. Several new ___s were announced at the event.",collaboration:"e.g. This ___ started at last year's conference."},
  18:{team:"e.g. Our joint ___ will have members from both universities.",group:"e.g. The working ___ meets online every Friday.",partner:"e.g. I hope you can be our research ___.",project:"e.g. The ___ will run for three years.",plan:"e.g. Let me outline the ___ for the first phase.",strategy:"e.g. Our ___ is to publish two papers per year.",policy:"e.g. The university ___ supports joint research.",program:"e.g. This exchange ___ benefits both departments."},
  19:{menu:"e.g. Let me show you the ___; they have great local dishes.",table:"e.g. I booked a ___ for two by the window.",food:"e.g. The ___ here is famous for Sichuan flavour.",drink:"e.g. What would you like to ___?",coffee:"e.g. Shall we have ___ after the meal?",tea:"e.g. This local ___ is very fragrant.",meat:"e.g. The braised ___ is their signature dish.",vegetable:"e.g. The stir-fried ___s are very fresh.",bill:"e.g. Don't worry, I'll get the ___."},
  20:{shop:"e.g. This ___ has everything we need.",market:"e.g. The ___ is open until 10 PM.",food:"e.g. We need to buy ___ for the whole week.",fruit:"e.g. The ___ section is on the left.",milk:"e.g. Grab a carton of ___ from the fridge.",bread:"e.g. This bakery ___ is freshly baked.",price:"e.g. The ___ is marked on the shelf.",money:"e.g. You can pay with cash or mobile ___.",bag:"e.g. Do you need a shopping ___?"},
  21:{kitchen:"e.g. The ___ has everything we need to cook.",dish:"e.g. Let's try making a Chinese ___ together.",bowl:"e.g. Put the noodles in this ___.",plate:"e.g. Serve the food on a big ___.",knife:"e.g. Use this ___ to cut the vegetables.",spoon:"e.g. Stir the soup with a ___.",cook:"e.g. I'll ___ the rice while you prepare the salad.",food:"e.g. The ___ smells delicious already!",meal:"e.g. This ___ is ready — let's eat!"},
  22:{sport:"e.g. What ___ would you like to try?",game:"e.g. Let's watch the ___ this weekend.",football:"e.g. We play ___ on the campus field every Saturday.",basketball:"e.g. There's a ___ court near the dormitory.",run:"e.g. I ___ along the river every morning.",exercise:"e.g. Daily ___ helps me stay focused on research.",team:"e.g. You can join our department ___.",competition:"e.g. The university ___ is next month."},
  23:{hospital:"e.g. The nearest ___ is about 15 minutes away.",doctor:"e.g. The ___ will see you in a few minutes.",nurse:"e.g. The ___ will take your temperature first.",medicine:"e.g. The ___ should be taken twice a day.",drug:"e.g. This ___ has no major side effects.",pill:"e.g. Take one ___ with water before bed.",health:"e.g. Your ___ is the top priority right now.",disease:"e.g. This ___ is common during winter."},
  24:{morning:"e.g. I usually start my ___ with a jog at 6 AM.",afternoon:"e.g. In the ___ I work in the lab.",evening:"e.g. I often read papers in the ___.",night:"e.g. I try to be in bed by 11 at ___.",work:"e.g. I ___ on my thesis from 9 to 5.",rest:"e.g. I take a short ___ after lunch.",sleep:"e.g. I need at least seven hours of ___.",schedule:"e.g. My daily ___ is quite regular."},
  25:{weather:"e.g. The ___ changes a lot between seasons here.",rain:"e.g. It tends to ___ heavily in July.",snow:"e.g. We get ___ from December to February.",wind:"e.g. The ___ can be quite strong in spring.",hot:"e.g. Summers here are very ___ and humid.",cold:"e.g. It gets extremely ___ in January.",season:"e.g. Autumn is my favourite ___.",temperature:"e.g. The ___ drops below zero in winter."},
  26:{internet:"e.g. The campus ___ requires a login password.",email:"e.g. I'll send you the file by ___.",message:"e.g. Send me a ___ when you arrive.",phone:"e.g. You can use your ___ to scan the QR code.",information:"e.g. All the ___ is on the university website.",update:"e.g. I'll give you an ___ after the meeting.",connection:"e.g. The wifi ___ in the library is very fast."},
  27:{friend:"e.g. Let me introduce you to a ___ of mine.",person:"e.g. This ___ is a fellow researcher in our group.",people:"e.g. The ___ here are very welcoming.",group:"e.g. Our ___ often has dinner together on Fridays.",student:"e.g. She is a PhD ___ working on AI.",visitor:"e.g. You are our first international ___ this year.",colleague:"e.g. My ___ Dr. Li works on the same project."},
  28:{name:"e.g. My ___ is Chen Wei — please call me Wei.",job:"e.g. My ___ is assistant professor of chemistry.",country:"e.g. I grew up in a small town in the north of our ___.",city:"e.g. I've lived in this ___ for ten years.",family:"e.g. My ___ is small — just my wife and our daughter.",study:"e.g. I ___ied mechanical engineering in college.",work:"e.g. I ___ on environmental monitoring systems.",experience:"e.g. I have five years of ___ in this field."},
  29:{music:"e.g. I enjoy listening to jazz ___ after work.",movie:"e.g. Have you seen any good ___s recently?",sport:"e.g. I started playing a new ___ last year.",book:"e.g. I'm reading a great ___ about world history.",travel:"e.g. I love to ___ during summer holidays.",hobby:"e.g. Photography is my favourite ___.",game:"e.g. We sometimes play board ___s on weekends."},
  30:{trip:"e.g. Let's plan a day ___ to the lake.",park:"e.g. The national ___ is about an hour's drive.",museum:"e.g. We could visit the science ___ on Saturday.",picnic:"e.g. How about a ___ by the river?",party:"e.g. I'm organising a small farewell ___.",barbecue:"e.g. Let's have a ___ at the outdoor area.",travel:"e.g. It's easy to ___ there by bus.",photo:"e.g. I'll take a ___ of us at the viewpoint."},
  31:{history:"e.g. This city has over 3,000 years of ___.",culture:"e.g. The local ___ blends Han and minority traditions.",art:"e.g. Traditional ___ forms include paper-cutting and calligraphy.",building:"e.g. This ancient ___ was a royal palace.",tradition:"e.g. Lantern-making is a ___ passed down for centuries.",local:"e.g. The ___ cuisine is famous for its spice.",festival:"e.g. The Dragon Boat ___ falls in June."},
  32:{custom:"e.g. One ___ here is to remove shoes before entering.",rule:"e.g. An unwritten ___ is to pour tea for elders first.",polite:"e.g. It is ___ to address people by their title.",behavior:"e.g. Table ___ is important during formal meals.",culture:"e.g. Understanding the ___ helps avoid misunderstandings.",respect:"e.g. Showing ___ to seniors is highly valued here.",communication:"e.g. Indirect ___ is common in this culture."},
  33:{happy:"e.g. I'm very ___ to have you here for this visit.",excited:"e.g. I feel ___ about our upcoming collaboration.",nervous:"e.g. I was a bit ___ before my first English presentation.",worried:"e.g. I'm ___ the weather might affect our trip.",proud:"e.g. I'm ___ of what our team has achieved.",surprised:"e.g. I was ___ by how much we accomplished.",curious:"e.g. I'm ___ about your research methods."},
  34:{problem:"e.g. There was a small ___ with the meeting room booking.",mistake:"e.g. I made a ___ with the date — it's Tuesday, not Monday.",misunderstanding:"e.g. It was a ___ caused by the language barrier.",explanation:"e.g. After your ___, everything became clear.",solution:"e.g. We quickly found a ___ together.",help:"e.g. Thank you for your ___ in resolving this."},
  35:{presentation:"e.g. My ___ covers the main findings of our study.",research:"e.g. This ___ was conducted over two years.",method:"e.g. The ___ section explains our experimental design.",result:"e.g. The ___s support our original hypothesis.",question:"e.g. I expect ___s about the sample size.",discussion:"e.g. Let's prepare key points for the ___ session."},
  36:{suggestion:"e.g. I have a ___ about your data-collection process.",improvement:"e.g. One area for ___ is the control group design.",idea:"e.g. Here's an ___ that could strengthen chapter three.",experiment:"e.g. The ___ could be repeated with more participants.",data:"e.g. The ___ quality looks good overall.",result:"e.g. The ___s in Table 2 are very convincing.",analysis:"e.g. Your statistical ___ is well done."},
  37:{fund:"e.g. We can apply for national ___s together.",grant:"e.g. The research ___ covers equipment and travel.",proposal:"e.g. The ___ must be submitted by December.",plan:"e.g. Let's outline the three-year ___.",project:"e.g. This joint ___ benefits both our departments.",application:"e.g. The ___ requires a detailed budget section.",budget:"e.g. We have a ___ of 500,000 yuan for the first year."},
  38:{course:"e.g. I teach a graduate ___ on data science.",class:"e.g. My ___ has 30 students this semester.",student:"e.g. The ___s are very engaged in discussions.",teaching:"e.g. My ___ load is about 12 hours per week.",lesson:"e.g. Each ___ includes a hands-on activity.",education:"e.g. Higher ___ reform is a hot topic now.",training:"e.g. The ___ workshop runs for three days."},
  39:{career:"e.g. A ___ in academia requires patience and dedication.",job:"e.g. I found my first ___ through a conference contact.",position:"e.g. There's an open ___ for a postdoctoral researcher.",experience:"e.g. International ___ is valued by hiring committees.",skill:"e.g. Grant-writing is an essential ___ for young scholars.",opportunity:"e.g. This collaboration is a great ___ for both of us."},
  40:{experience:"e.g. This ___ has been unforgettable for both of us.",memory:"e.g. I will treasure the ___ies we made here.",friendship:"e.g. Our ___ will continue beyond this visit.",future:"e.g. I look forward to working together in the ___.",cooperation:"e.g. I hope our ___ produces great results.",plan:"e.g. My ___ is to visit your university next spring."},
  41:{mountain:"e.g. The ___s here turn golden in autumn.",air:"e.g. The ___ is incredibly fresh outside the city.",light:"e.g. The morning ___ through the trees is beautiful.",water:"e.g. The ___ in this stream is crystal clear.",river:"e.g. The ___ flows down from the hills.",field:"e.g. The green ___s stretch all the way to the horizon.",forest:"e.g. We walked through a bamboo ___.",sky:"e.g. The ___ looks so blue without the city haze.",stone:"e.g. I collected a smooth ___ from the riverbed."},
  42:{animal:"e.g. What ___ are you most interested in seeing?",bird:"e.g. That ___ with the red head is a woodpecker.",cat:"e.g. A ___ is resting under the bench.",dog:"e.g. Someone is walking their ___ along the path.",insect:"e.g. There are many kinds of ___s near the pond.",bee:"e.g. A ___ is collecting pollen from the flower.",butterfly:"e.g. A blue ___ just landed on the bush.",spider:"e.g. Look at the web that ___ built overnight.",plant:"e.g. This ___ blooms only in early spring."},
  43:{body:"e.g. The doctor examined my whole ___.",head:"e.g. Do you have any pain in your ___?",eye:"e.g. The doctor checked both ___s with a light.",ear:"e.g. They tested my ___s for hearing ability.",heart:"e.g. Your ___ rate is normal and healthy.",lung:"e.g. Take a deep breath so they can check your ___s.",muscle:"e.g. The doctor pressed on the ___ to check for pain.",bone:"e.g. The X-ray showed no ___ fracture.",health:"e.g. Overall, your ___ condition is very good."},
  44:{parent:"e.g. My ___s are both retired school teachers.",daughter:"e.g. My ___ just started primary school.",son:"e.g. Our ___ is studying medicine in Shanghai.",father:"e.g. My ___ loves to go fishing on weekends.",mother:"e.g. My ___ makes the best dumplings.",brother:"e.g. My younger ___ works in IT.",sister:"e.g. My ___ lives abroad with her family.",husband:"e.g. My ___ is also a university lecturer.",wife:"e.g. My ___ works at the local hospital."},
  45:{room:"e.g. Your ___ is small but has everything you need.",floor:"e.g. The ___ has just been cleaned.",wall:"e.g. You can hang a picture on this ___.",window:"e.g. Open the ___ to let fresh air in.",door:"e.g. The ___ locks automatically when you close it.",furniture:"e.g. The ___ includes a desk, chair, and bookshelf.",bed:"e.g. The ___ has clean sheets and a warm blanket.",chair:"e.g. This ___ is adjustable for comfort.",desk:"e.g. Put your laptop on the ___.",table:"e.g. There's a small ___ for your meals."},
  46:{news:"e.g. Did you hear the ___ about the new metro line?",event:"e.g. The ___ attracted thousands of people.",information:"e.g. I read more ___ about it online.",fact:"e.g. The ___ is, the project finished ahead of schedule.",evidence:"e.g. There is ___ that the policy is working.",report:"e.g. The government ___ was released yesterday.",update:"e.g. Here's the latest ___ on the situation.",notice:"e.g. I saw a ___ about it on the bulletin board."},
  47:{problem:"e.g. Air pollution is a serious ___ in many cities.",people:"e.g. More ___ are choosing public transport now.",government:"e.g. The local ___ introduced new recycling rules.",policy:"e.g. This ___ aims to reduce carbon emissions.",change:"e.g. We need real ___ to protect the environment.",society:"e.g. A healthy ___ invests in education.",future:"e.g. What kind of ___ do we want for our children?",reason:"e.g. The main ___ for this issue is rapid urbanisation."},
  48:{museum:"e.g. This ___ has over 10,000 items in its collection.",history:"e.g. The ___ section covers the last 500 years.",culture:"e.g. You can see traditional ___ in every room.",art:"e.g. The ___ gallery upstairs is stunning.",building:"e.g. The ___ itself is a protected historic monument.",tradition:"e.g. These crafts represent a living ___.",collection:"e.g. The jade ___ is the most popular exhibit.",guide:"e.g. The ___ explained each piece in detail."},
};

function spcVocabExample(word, scene) {
  const sceneExamples = SPC_SCENE_EXAMPLES[scene.id];
  if (sceneExamples && sceneExamples[word]) return sceneExamples[word];
  return "";
}
...
function spcStartRec() {
  ...
  if (SR) {
    ...
    spcRecognition.onresult = (e) => {
      ...
      const ph = document.querySelector("#spc-tbox .spc-placeholder");
      if (ph) ph.remove();
  ...
  try {
    ...
    for (let attempt = 0; attempt < 3; attempt++) {
      ...
      if (res.status === 429 && attempt < 2) {
        ...
        console.warn(`Gemini 429, retrying in ${wait}ms...`);
